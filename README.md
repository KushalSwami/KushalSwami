...
<title>Kushal Swami — IT Program Coordinator | Project Manager | NJ/NYC</title>
<meta name="description" content="Kushal Swami is an IT Program Coordinator and Project Manager based in Clifton, NJ with 4+ years of enterprise delivery experience including a $90M POS modernization program at Ahold Delhaize. Smartsheet and SharePoint Administrator. Rutgers MIS graduate.">
<meta name="keywords" content="Kushal Swami, IT Program Coordinator, Project Manager, PMO Analyst, Smartsheet Administrator, SharePoint Administrator, Rutgers MIS, Clifton NJ, Ahold Delhaize, program governance">
<meta name="author" content="Kushal Swami">
<meta name="robots" content="index, follow">
<!-- Open Graph -->
<meta property="og:title" content="Kushal Swami — IT Program Coordinator & Project Manager">
<meta property="og:description" content="4+ years of enterprise IT delivery experience. $90M program. Smartsheet & SharePoint Admin. Rutgers MIS Magna Cum Laude.">
<meta property="og:type" content="profile">
<meta property="og:url" content="https://kushalswami.github.io/KushalSwami/">
<!-- Canonical -->
<link rel="canonical" href="https://kushalswami.github.io/KushalSwami/">
...
<script type="application/ld+json">
{
  ...
  "@type": "Person",
  "name": "Kushal Swami",
  "jobTitle": "IT Program Coordinator",
  "description": "IT Program Coordinator and Project Manager with 4+ years of enterprise delivery experience",
  "url": "https://kushalswami.github.io/KushalSwami/",
  "email": "Kswami96@outlook.com",
  "address": {
    "@type": "PostalAddress",
  ...
  "alumniOf": [
    {
      ...
      "sameAs": "https://www.business.rutgers.edu/"
    },
    {
      "@type": "CollegeOrUniversity",
  ...
  "knowsAbout": ["Program Management", "Smartsheet", "SharePoint", "Project Coordination", "PMO", "SQL", "Python", "IT Governance"],
  "sameAs": ["https://www.linkedin.com/in/kushalswami"]
}
</script>
...
.nav-cta {
  ...
  border: 1px solid var(--work-accent) !important;
...
#hero::after {
  ...
  background: radial-gradient(circle, rgba(78,158,122,0.07) 0%, transparent 70%);
  pointer-events: none;
}
...
.btn-primary:hover { background: #5db88c; transform: translateY(-1px); }
...
.highlight-icon { font-size: 26px; margin-bottom: 18px; }
...
.card-org   { font-size: 12px; color: #8a9ab8; margin-bottom: 8px; }
.card-dates {
  font-size: 11px;
  color: #8a9ab8;
  letter-spacing: 1px;
...
.card:hover .card-details { max-height: 600px; opacity: 1; }
.card.edu .card-details   { max-height: 600px; opacity: 1; }
...
<div id="stats">
  ...
  <div class="stat">
    ...
    <div class="stat-label">Years Program Experience</div>
  </div>
  <div class="stat">
    <div class="stat-number">8+</div>
    <div class="stat-label">Years Technical Experience</div>
  </div>
  <div class="stat">
...
<section id="timeline">
  ...
  <!-- 2026 marker = start of 2026 -->

  <!-- IT Program Coordinator — ended Feb 2026 -->
  ...
  <!-- 2023 marker = start of 2023 -->
  <div class="spacer"></div>

  <!-- B.S. Rutgers — graduated 2023 -->
  ...
  <div class="spacer"></div>
  <!-- 2019 marker = start of 2019 -->
  <div class="spacer"></div>

  <!-- Technical Project Coordinator Diversified — ended Dec 2019 -->
  <div class="timeline-row left">
    <div class="card work">
  ...
  <!-- IT Project Coordinator Steve Rich — ended Jun 2019 (below Diversified which ended Dec 2019) -->
  <div class="timeline-row left">
    <div class="card work">
  ...
  <div class="spacer"></div>
  <!-- 2018 marker = start of 2018 -->
  <div class="spacer"></div>

  <!-- A.S. Bergen CC — graduated 2018 -->
  <div class="timeline-row right">
    <div class="card edu">
      <div class="card-type">Education</div>
  ...
  <!-- Cyber Security Intern NJ Governor — Summer 2018 (after Bergen graduation) -->
  <div class="timeline-row left">
    <div class="card work">
  ...
  <div class="spacer"></div>
  <!-- 2017 marker = start of 2017 -->
  <div class="spacer"></div>

  <!-- Congressional Intern — Summer 2017 -->
  <div class="timeline-row left">
    <div class="card work">
      <div class="card-type">Work · Internship</div>
  ...
  <div class="spacer"></div>
  <!-- 2016 marker = start of 2016 -->
  <div class="spacer"></div>

  <!-- Alliance Advisors — ended Dec 2016 -->
  <div class="timeline-row left">
    <div class="card work">
      <div class="card-type">Work</div>
  ...
  <div class="spacer"></div>
  <!-- 2015 marker = start of 2015 -->
  <div class="spacer"></div>

  <!-- Service Director Volunteer — started ~2015 during BCC -->
  <div class="timeline-row right">
    <div class="card vol">
...
<section id="contact">
  <div class="contact-inner">
    ...
    <div class="contact-links">
      <a href="/cdn-cgi/l/email-protection#7b30080c1a1612424d3b140e0f1714141055181416" class="contact-link">✉ Email</a>
      <a href="https://linkedin.com/in/kushalswami" target="_blank" rel="noopener" class="contact-link">⟶ LinkedIn</a>
    </div>
    <a href="/cdn-cgi/l/email-protection#5d162e2a3c3034646b1d32282931323236733e3230" class="contact-email"><span class="__cf_email__" data-cfemail="4b00383c2a2622727d0b243e3f2724242065282426">[email&#160;protected]</span></a>
  </div>
</section>
